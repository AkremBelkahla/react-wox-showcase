...
const contentSlides = [
  {
    ...
    text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,n ullama commodo consequat. Duiidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    type: "content"
  },
  {
    title: "Our Culture & Values",
    text: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritunt. Neque porro quisquam est, qui dolorem ipsum quian culpa qui officia deserunt mollit anim id est laborum.",
    type: "content"
  },
  {
    title: "Why Join Us",
    text: "At vero eos et accusamus et iusto odue nihil impedit quo minus id quod maxime placeat facere possimus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmodm.",
    type: "content"
  },
  {
    type: "form",
...
const countries = [
  ...
  "India", "China", "Brazil", "Australia", "South Africa"
];
                  ...
                  <form className="space-y-4" onSubmit={async (e) => {
                    ...
                    try {
                      ...
                      const templateParams = {
                        ...
                        subject: `Nouvelle candidature de ${formData.get('firstName')} ${formData.get('lastName')}`,
                        message: `
